                  ...
                  <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                    <div class="card" style="border-radius: 15px;">
                      <div class="card-body p-5">
                        <h2 class="text-uppercase text-center mb-5">Liste des reservation</h2>
                        <ul class="list-group" id="liste_reservation"></ul>
                      </div>
                    </div>
                  </div>
                </div>
...
<script>
    ...
    $.ajax({
      url : "ListReservation.php",
      type : "POST",
      success : function(data){
        $("#liste_reservation").html(data);
      }
    });
    }
